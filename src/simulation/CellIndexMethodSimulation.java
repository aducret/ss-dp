...
public class CellIndexMethodSimulation {
	...
	public CellIndexMethodSimulation(SimulationData simulationData, Integer M, Boolean hasPeriodicBoundaries) {
		if (M == null || hasPeriodicBoundaries == null || simulationData == null)
	...
	public void simulate(SimulationListener simulationListener) {
		clearNeighbors();
